...
// Regression test ensuring /auth/google static notice & link presence.
...
describe('Auth forwarder page', () => {
  it('renders static notice when NEXT_PUBLIC_PAGES_STATIC=1', () => {
    ...
    return import('../app/auth/google/page').then(mod => {
      ...
      const link = container.querySelector('a[href^="https://app.istampit.io/auth/google"]') as HTMLAnchorElement;
